class UI {
    //Display all the Drick Categories
    displayCategories (){
        const categoryList = cocktail.getCategories()
            .then(categories => {
                const catLit = categories.categories.drinks;
    ...
    displayDrinksWithIngrediets(drinks) {
         

        // Insert the results
        const resultsDiv = document.querySelector("#results");

        // "https://www.thecocktaildb.com/images/media/drink/5noda61589575158.jpg"  strDrinkThumb
    ...
    // Prints the ingredients and Measurnments
